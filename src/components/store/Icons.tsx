...
export const IconTikTok = (p: IconProps) => (
  <svg
    ...
    {...p}
  >
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 2.23-1.15 4.38-2.9 5.76-1.74 1.38-4.04 1.83-6.19 1.25-2.14-.57-3.92-2.12-4.71-4.14-.78-2.02-.63-4.33.4-6.22 1.02-1.89 2.9-3.23 5-3.64.67-.13 1.35-.16 2.03-.11v4.02c-.39-.02-.79-.02-1.18.06-.9.19-1.74.75-2.22 1.51-.48.75-.59 1.7-.29 2.53.3.83.98 1.48 1.8 1.75.82.26 1.73.13 2.45-.33.72-.45 1.21-1.22 1.33-2.05.09-.64.07-1.3-.07-1.93-.03-2.96-.02-5.91-.02-8.87V.02z" />
  </svg>
);